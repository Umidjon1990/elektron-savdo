...
export default function DebtorsPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <SidebarNav />
      <main className="flex-1 p-4 md:p-6 pb-24 md:pb-6 overflow-auto" data-testid="debtors-page">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Nasiya qarzlarni boshqarish</p>
            </div>
          </div>
          ...
          <Card>
            <CardContent className="p-0">
              {isLoading ? (
                <div className="p-8 text-center text-slate-500" data-testid="loading-indicator">
                  Yuklanmoqda...
                </div>
              ) : filteredDebtors.length === 0 ? (
                <div className="p-8 text-center text-slate-500" data-testid="empty-state">
